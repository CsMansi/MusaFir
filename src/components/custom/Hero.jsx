...
const Hero = () => {
  return (
    <div className='flex items-center flex-col m-16'>
      ...
      <h2 className=' text-2xl text-center text-white-100 m-13 w-[60%]'>Unburden yourself from the noise of daily life and the hassle of planning. Our smart AI builds your perfect path to peace and adventure.</h2>
